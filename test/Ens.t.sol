...
contract EnsTest is Test {
    ...
    function testRegisterMultipleNames() public {
        ...
        for (uint i = 0; i < ownedNames.length; i++) {
    ...
    function testTransferNameMultiple() public {
        ...
        bool foundName2 = false;
        for (uint i = 0; i < user1Names.length; i++) {
    ...
    function testContractOwnerSet()  view public {
    ...
    function testCompleteWorkflow() public {
        ...
        // Verify final state
        (address recordOwner, address resolvedAddress, string memory imageHash,) = 
            ens.resolveName(NAME1);
